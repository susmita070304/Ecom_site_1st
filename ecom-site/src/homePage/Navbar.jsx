...
export default function Navbar() {
      ...
      return (
         ...
         {/* Cart icon */}
                  ...
                  {/* Profile Drawer */}
                  <div
                        className={`fixed top-0 right-0 h-full w-[300px] bg-white shadow-lg transform transition-transform duration-300 z-50 ${drawerOpen ? "translate-x-0" : "translate-x-full"
                              }`}
                  >
                        {/* Close Button */}
                        <button
                  ...
                  {/* Hamburger Drawer */}
                  <div
                        className={`fixed top-12 right-0 h-60 w-64 bg-white shadow-lg transform transition-transform duration-300 z-40 ${isOpen ? "translate-x-0" : "translate-x-full"
                              }`}
                  >
                        <button
